        ...
        <div className="flex items-center gap-2 sm:gap-2.5">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl bg-lowveld-950/80 hover:bg-lowveld-900 border border-emerald-500/30 text-emerald-300 text-xs font-semibold transition-all"
            >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs sm:text-sm font-semibold bg-[#005c4b]/80 hover:bg-[#005c4b] text-emerald-100 border border-emerald-500/30 transition-all hover:scale-[1.02] shadow-sm shadow-emerald-950"
          ...
          {isAuthenticated && user ? (
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-emerald-500/20 hover:bg-emerald-500/30 border border-emerald-500/40 text-emerald-200 text-xs font-bold transition-all"
              >
                <div className="w-5 h-5 rounded-full bg-emerald-500 text-white text-[10px] font-black flex items-center justify-center">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs sm:text-sm font-bold bg-gradient-to-r from-emerald-500 to-lowveld-600 hover:from-emerald-400 hover:to-lowveld-500 text-white shadow-lg shadow-emerald-900/30 transition-all hover:scale-[1.02]"
          >
